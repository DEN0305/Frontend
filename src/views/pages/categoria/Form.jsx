...
import CategoriaFormValidate from "../../../services/CategoriaForm";
...
const Formulario = ( ) => {
    ...
    const {
        ...
        handleBlur,
        handleSubmit,
    } = useForm(initialForm, CategoriaFormValidate.validationsForm);
                    ...
                    <CardHeader className="">
                      <div className="align-items-center row">
                        <div className="col-11">
                          <h3 className="mb-0">{module?.toUpperCase()} CATEGORÍA</h3>
