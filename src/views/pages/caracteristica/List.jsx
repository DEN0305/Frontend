...
function List({ tab }) {
    ...
    { 
      ...
      cell: row => (
        ...
        <Link className='btn btn-sm'
              color="primary"
              to={"/admin/caracteristica/detail/"+row.id}
              style={{
  ...
  return (
    <>
    {state.alert}
    <Header brandText="Características" />
          ...
          <Card className="shadow">
              ...
              <div className="align-items-center row">
                <div className="col-11">
                  ...
                  <p className="text-sm mb-0">
                    Listado de características registradas en el sistema
                  </p>
                </div>
              </div>
            </CardHeader>
            <CardBody>
              ...
              <DataTable
                ...
                highlightOnHover
                responsive
                noDataComponent="No hay características registradas"
              />
              <div className="m-3">
                <Link 
