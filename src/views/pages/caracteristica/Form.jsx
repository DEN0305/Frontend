...
const Formulario = ( ) => {
    ...
    // Función de restricción de entrada para descripción
                    ...
                    <CardHeader className="">
                      <div className="align-items-center row">
                        <div className="col-11">
                          <h3 className="mb-0">{module?.toUpperCase()} CARACTERÍSTICA</h3>
                          <p className="text-sm mb-0">
                            Formulario de gestión de características
                          </p>
                        </div>
                      </div>
                    </CardHeader>
                            ...
                            <Row>
                                <Col lg="12">
                                    <FormGroup>
                                        ...
                                        >
                                        Nombre de la característica <span className="text-danger">*</span>
                                        </label>
                                        <Input
                                        className="form-control"
                                        id="input-descripcion"
                                        placeholder="Ej: Color, Tamaño, Procesador, Marca, etc."
                                        type="text"
                                        name="descripcion"
                                        required="required"
